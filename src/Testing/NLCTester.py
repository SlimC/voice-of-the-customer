...
VIEW = ''  # Replace with the view from your database to poll, be the name of
              # the view and should return the text to classify
...
view = db.get_view_result(DESIGN, VIEW)
